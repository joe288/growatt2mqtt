...
*/
     ...
     * @param rx RX pin
     * @param tx TX pin
     * @param de DE pin for RS485 (optional, -1 if not used)
     * @param re RE pin for RS485 (optional, -1 if not used)
     */
    DalyBms(int rx, int tx, int de = -1, int re = -1);

    DalyBms(SoftwareSerial* serialPtr, int de = -1, int re = -1);
